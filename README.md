...
✅ Agent-PPT Skill 为原生 PPT 智能生成工具，适配国内各类办公场景，输出版式规范、观感优质。

## 使用声明

⚠️ **版权约束**：本项目及配套内置模板仅限个人学习、学术研究使用，严禁一切商业用途。

## 增值服务

📌 支持私有化模板定制：若需让智能 Agent 按照企业专属 PPT 规范自动生成文稿，可添加微信 **Yu_Z0809** 对接定制服务。

## 交流群

加我微信Yu_Z0809，拉你进PPT Skill交流群，AI话题也可以讨论。
